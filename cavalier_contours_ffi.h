...
constexpr static const uint32_t CAVC_SELF_INTERSECTS_INCLUDE_ALL = 0;

constexpr static const uint32_t CAVC_SELF_INTERSECTS_INCLUDE_LOCAL = 1;

constexpr static const uint32_t CAVC_SELF_INTERSECTS_INCLUDE_GLOBAL = 2;

/// FFI Representation of PlineContainsResult enum
constexpr static const uint32_t CAVC_CONTAINS_RESULT_INVALID_INPUT = 0;

constexpr static const uint32_t CAVC_CONTAINS_RESULT_PLINE1_INSIDE_PLINE2 = 1;

constexpr static const uint32_t CAVC_CONTAINS_RESULT_PLINE2_INSIDE_PLINE1 = 2;

constexpr static const uint32_t CAVC_CONTAINS_RESULT_DISJOINT = 3;

constexpr static const uint32_t CAVC_CONTAINS_RESULT_INTERSECTED = 4;
...
struct cavc_pline_parallel_offset_o {
  const cavc_aabbindex *aabb_index;
...
struct cavc_pline_boolean_o {
  const cavc_aabbindex *pline1_aabb_index;
  double pos_equal_eps;
...
struct cavc_pline_self_intersect_o {
  const cavc_aabbindex *pline_aabb_index;
  double pos_equal_eps;
  uint32_t include;
};

/// FFI representation of [PlineContainsOptions].
struct cavc_pline_contains_o {
  const cavc_aabbindex *pline1_aabb_index;
  double pos_equal_eps;
};
...
int32_t cavc_pline_parallel_offset_o_create(cavc_pline_parallel_offset_o **options);
...
void cavc_pline_parallel_offset_o_f(cavc_pline_parallel_offset_o *options);
...
///
/// `options` must point to a valid place in memory to be written.
int32_t cavc_pline_parallel_offset_o_init(cavc_pline_parallel_offset_o *options);
...
///
/// `options` must point to a valid place in memory to be written.
int32_t cavc_pline_boolean_o_create(cavc_pline_boolean_o **options);
...
/// has not already been freed.
void cavc_pline_boolean_o_f(cavc_pline_boolean_o *options);
...
///
/// `options` must point to a valid place in memory to be written.
int32_t cavc_pline_boolean_o_init(cavc_pline_boolean_o *options);
...
///
/// `options` must point to a valid place in memory to be written.
int32_t cavc_pline_self_intersect_o_create(cavc_pline_self_intersect_o **options);
...
/// has not already been freed.
void cavc_pline_self_intersect_o_f(cavc_pline_self_intersect_o *options);
...
///
/// `options` must point to a valid place in memory to be written.
int32_t cavc_pline_self_intersect_o_init(cavc_pline_self_intersect_o *options);
...
int32_t cavc_pline_create(const cavc_vertex *vertexes,
                          uint32_t n_vertexes,
                          uint8_t is_closed,
                          const cavc_pline **pline);
...
/// has not already been freed.
void cavc_pline_f(cavc_pline *pline);
...
int32_t cavc_pline_set_userdata_values(cavc_pline *pline,
...
int32_t cavc_pline_get_userdata_count(const cavc_pline *pline, uint32_t *count);
...
/// overrun will happen.
int32_t cavc_pline_get_userdata_values(const cavc_pline *pline,
...
/// `pline` must be null or a valid cavc_pline object that was created with [cavc_pline_create] and
/// has not been freed.
int32_t cavc_pline_reserve(cavc_pline *pline, uint32_t additional);
...
int32_t cavc_pline_clone(const cavc_pline *pline, const cavc_pline **cloned);
...
int32_t cavc_pline_get_is_closed(const cavc_pline *pline, uint8_t *is_closed);
...
/// `pline` must be null or a valid cavc_pline object that was created with [cavc_pline_create] and
/// has not been freed.
int32_t cavc_pline_set_is_closed(cavc_pline *pline, uint8_t is_closed);
...
/// has not been freed.
/// `count` must point to a valid place in memory to be written.
int32_t cavc_pline_get_vertex_count(const cavc_pline *pline, uint32_t *count);
...
/// overrun will happen.
int32_t cavc_pline_get_vertex_data(const cavc_pline *pline, cavc_vertex *vertex_data);
...
int32_t cavc_pline_set_vertex_data(cavc_pline *pline,
                                   const cavc_vertex *vertex_data,
                                   uint32_t n_vertexes);
...
/// `pline` must be null or a valid cavc_pline object that was created with [cavc_pline_create] and
/// has not been freed.
int32_t cavc_pline_clear(cavc_pline *pline);
...
/// `pline` must be null or a valid cavc_pline object that was created with [cavc_pline_create] and
/// has not been freed.
int32_t cavc_pline_add(cavc_pline *pline, double x, double y, double bulge);
...
int32_t cavc_pline_get_vertex(const cavc_pline *pline, uint32_t position, cavc_vertex *vertex);
...
/// `pline` must be null or a valid cavc_pline object that was created with [cavc_pline_create] and
/// has not been freed.
int32_t cavc_pline_set_vertex(cavc_pline *pline, uint32_t position, cavc_vertex vertex);
...
/// `pline` must be null or a valid cavc_pline object that was created with [cavc_pline_create] and
/// has not been freed.
int32_t cavc_pline_remove(cavc_pline *pline, uint32_t position);
...
int32_t cavc_pline_eval_path_length(const cavc_pline *pline, double *path_length);
...
int32_t cavc_pline_eval_area(const cavc_pline *pline, double *area);
...
int32_t cavc_pline_eval_wn(const cavc_pline *pline, double x, double y, int32_t *winding_number);
...
/// written.
int32_t cavc_pline_eval_closest_point(const cavc_pline *pline,
                                      double x,
                                      double y,
                                      double pos_equal_eps,
                                      uint32_t *seg_start_index,
                                      cavc_point *closest_point,
                                      double *distance);
...
/// `pline` must be null or a valid cavc_pline object that was created with [cavc_pline_create] and
/// has not been freed.
int32_t cavc_pline_invert_direction(cavc_pline *pline);
...
/// `pline` must be null or a valid cavc_pline object that was created with [cavc_pline_create] and
/// has not been freed.
int32_t cavc_pline_scale(cavc_pline *pline, double scale_factor);
...
/// `pline` must be null or a valid cavc_pline object that was created with [cavc_pline_create] and
/// has not been freed.
int32_t cavc_pline_translate(cavc_pline *pline, double x_offset, double y_offset);
...
/// `pline` must be null or a valid cavc_pline object that was created with [cavc_pline_create] and
/// has not been freed.
int32_t cavc_pline_remove_repeat_pos(cavc_pline *pline, double pos_equal_eps);
...
/// `pline` must be null or a valid cavc_pline object that was created with [cavc_pline_create] and
/// has not been freed.
int32_t cavc_pline_remove_redundant(cavc_pline *pline, double pos_equal_eps);
...
int32_t cavc_pline_eval_extents(const cavc_pline *pline,
                                double *min_x,
                                double *min_y,
                                double *max_x,
                                double *max_y);
...
int32_t cavc_pline_parallel_offset(const cavc_pline *pline,
                                   double offset,
                                   const cavc_pline_parallel_offset_o *options,
                                   const cavc_plinelist **result);
...
int32_t cavc_pline_boolean(const cavc_pline *pline1,
                           const cavc_pline *pline2,
                           uint32_t operation,
                           const cavc_pline_boolean_o *options,
                           const cavc_plinelist **pos_plines,
                           const cavc_plinelist **neg_plines);
...
int32_t cavc_pline_scan_for_self_intersect(const cavc_pline *pline,
                                           const cavc_pline_self_intersect_o *options,
...
/// [cavc_pline_create] and has not been freed.
/// `result` must point to a valid place in memory to be written.
int32_t cavc_pline_contains(const cavc_pline *pline1,
                            const cavc_pline *pline2,
...
int32_t cavc_pline_create_approx_aabbindex(const cavc_pline *pline,
                                           const cavc_aabbindex **aabbindex);
...
/// has not been freed.
/// `aabbindex` must point to a valid place in memory to be written.
int32_t cavc_pline_create_aabbindex(const cavc_pline *pline, const cavc_aabbindex **aabbindex);
...
void cavc_aabbindex_f(cavc_aabbindex *aabbindex);
...
/// `aabbindex` must be null or a valid [cavc_aabbindex] object.
/// `min_x`, `min_y`, `max_x`, and `max_y` must all point to a valid places in memory to be written.
int32_t cavc_aabbindex_get_extents(const cavc_aabbindex *aabbindex,
                                   double *min_x,
                                   double *min_y,
                                   double *max_x,
                                   double *max_y);
...
int32_t cavc_plinelist_create(uintptr_t capacity, cavc_plinelist **plinelist);
...
void cavc_plinelist_f(cavc_plinelist *plinelist);
...
/// `plinelist` must be null or a valid [cavc_plinelist] object.
/// `count` must point to a valid place in memory to be written.
int32_t cavc_plinelist_get_count(const cavc_plinelist *plinelist, uint32_t *count);
...
/// `plinelist` must be null or a valid [cavc_plinelist] object.
/// `pline` must point to a valid place in memory to be written.
int32_t cavc_plinelist_get_pline(const cavc_plinelist *plinelist,
                                 uint32_t position,
                                 const cavc_pline **pline);
...
int32_t cavc_plinelist_push(cavc_plinelist *plinelist, cavc_pline *pline);
...
int32_t cavc_plinelist_pop(cavc_plinelist *plinelist,
                           const cavc_pline **pline);
...
/// `plinelist` must be null or a valid [cavc_plinelist] object.
/// `pline` must point to a valid place in memory to be written, or null if you don't need the pointer to the [cavc_pline].
int32_t cavc_plinelist_take(cavc_plinelist *plinelist,
                            uint32_t position,
                            const cavc_pline **pline);
...
///
/// `options` must point to a valid place in memory to be written.
int32_t cavc_shape_offset_o_init(cavc_shape_offset_o *options);
...
int32_t cavc_shape_create(const cavc_plinelist *plinelist, cavc_shape **shape);
...
/// has not already been freed.
void cavc_shape_f(cavc_shape *shape);
...
/// has not been freed.
/// `result` must point to a valid place in memory to be written.
int32_t cavc_shape_parallel_offset(const cavc_shape *shape,
                                   double offset,
                                   const cavc_shape_offset_o *options,
                                   cavc_shape **result);
...
/// `vertex_data` must point to a buffer that is large enough to hold all the vertexes or a buffer
/// overrun will happen.
int32_t cavc_shape_get_ccw_polyline_vertex_data(const cavc_shape *shape,
                                                uint32_t polyline_index,
                                                cavc_vertex *vertex_data);
...
/// has not been freed.
/// `userdata_values` must point to a valid location to read from.
int32_t cavc_shape_set_ccw_pline_userdata_values(cavc_shape *shape,
                                                 uint32_t polyline_index,
                                                 const uint64_t *userdata_values,
                                                 uint32_t count);
...
/// has not been freed.
/// `count` must point to a valid place in memory to be written.
int32_t cavc_shape_get_ccw_pline_userdata_count(const cavc_shape *shape,
                                                uint32_t polyline_index,
                                                uint32_t *count);
...
/// `userdata_values` must point to a buffer that is large enough to hold all the userdata values or a buffer
/// overrun will happen.
int32_t cavc_shape_get_ccw_pline_userdata_values(const cavc_shape *shape,
                                                 uint32_t polyline_index,
                                                 uint64_t *userdata_values);
...
/// `vertex_data` must point to a buffer that is large enough to hold all the vertexes or a buffer
/// overrun will happen.
int32_t cavc_shape_get_cw_polyline_vertex_data(const cavc_shape *shape,
                                               uint32_t polyline_index,
                                               cavc_vertex *vertex_data);
...
/// has not been freed.
/// `userdata_values` must point to a valid location to read from.
int32_t cavc_shape_set_cw_pline_userdata_values(cavc_shape *shape,
                                                uint32_t polyline_index,
                                                const uint64_t *userdata_values,
                                                uint32_t count);
...
/// has not been freed.
/// `count` must point to a valid place in memory to be written.
int32_t cavc_shape_get_cw_pline_userdata_count(const cavc_shape *shape,
                                               uint32_t polyline_index,
                                               uint32_t *count);
...
/// `userdata_values` must point to a buffer that is large enough to hold all the userdata values or a buffer
/// overrun will happen.
int32_t cavc_shape_get_cw_pline_userdata_values(const cavc_shape *shape,
                                                uint32_t polyline_index,
                                                uint64_t *userdata_values);
