# Phase 65: capi-specific-edge-matrix-open-rectangle-inward-expansion - Context
...
Phase 65 further expands source-backed specific-edge options-path matrix
coverage by adding an additional old C++ open-rectangle-inward case into the
...
- **D-01:** Keep using the shared specific-edge runner helper introduced in
  Phase 56 and expanded through Phase 64.
