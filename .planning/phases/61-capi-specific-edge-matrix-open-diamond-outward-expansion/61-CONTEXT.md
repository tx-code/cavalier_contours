# Phase 61: capi-specific-edge-matrix-open-diamond-outward-expansion - Context
...
Phase 61 further expands source-backed specific-edge options-path matrix
coverage by adding an additional old C++ open-diamond-outward case into the
...
- **D-01:** Keep using the shared specific-edge runner helper introduced in
  Phase 56 and expanded through Phase 60.
