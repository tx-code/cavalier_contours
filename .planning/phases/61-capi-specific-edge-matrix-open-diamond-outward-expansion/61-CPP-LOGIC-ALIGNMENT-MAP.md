# Phase 61: C-API Logic Alignment Map
...
- Specific-edge matrix coverage now also includes `open_diamond_outward` in the
  same helper-driven reversed/default options-path flow.
