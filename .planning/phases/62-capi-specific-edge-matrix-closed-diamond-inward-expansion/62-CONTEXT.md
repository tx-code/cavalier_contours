# Phase 62: capi-specific-edge-matrix-closed-diamond-inward-expansion - Context
...
Phase 62 further expands source-backed specific-edge options-path matrix
coverage by adding an additional old C++ closed-diamond-inward case into the
...
- **D-01:** Keep using the shared specific-edge runner helper introduced in
  Phase 56 and expanded through Phase 61.
