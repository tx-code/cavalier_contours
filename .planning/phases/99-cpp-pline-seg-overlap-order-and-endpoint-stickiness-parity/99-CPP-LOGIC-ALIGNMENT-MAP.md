...
- Added Rust options-path canonical-name counterpart for non-circle wrap-around
  ...
  - verifies `find_intersects_opt` remains aligned with default-path
    ...
    immutability).
- Added Rust options-path canonical-name counterpart for non-circle wrap-around
  open-side-reversed closed-pline2-with-closure-basic role-flip
  nonzero-open-index fixture:
  ...
  - verifies `find_intersects_opt` remains aligned with default-path
    ...
    immutability).
- Added Rust options-path canonical-name counterpart for non-circle wrap-around
  open-side-reversed closed-pline2-with-closure-basic-intersect role-flip
  nonzero-open-index fixture:
...
- Added Rust options-path canonical-name counterpart for non-circle wrap-around
  open-side-reversed closed-pline2 closure-basic-intersect
  start-index-rotation zero-length-lead role-flip fixture:
  - `cpp_wrap_around_open_side_reversed_closed_pline2_closure_basic_intersect_start_index_rotation_zero_length_lead_role_flip_options_parity`
  - verifies `find_intersects_opt` remains aligned with default-path
    `find_intersects` outputs (counts, AB/BA role inversion, rotated
    zero-length-lead index-attribution semantics, role-flip ordering semantics,
    and input immutability).
- Added Rust options-path canonical-name counterpart for non-circle
  reversed-endpoint-order closure-basic role-flip fixture matrix:
...
- Added Rust options-path canonical-name counterpart for non-circle
  ...
  - verifies `find_intersects_opt` remains aligned with default-path
    ...
    and input immutability).
- Added Rust options-path canonical-name counterpart for non-circle
  reversed-endpoint-order closure-basic-intersect role-flip fixture matrix:
  - `cpp_reversed_endpoint_closure_basic_intersect_role_flip_options_matrix_parity`
  - verifies `find_intersects_opt` remains aligned with default-path
    `find_intersects` outputs across closed-`pline1` and closed-`pline2`
    role-flip variants (counts, AB/BA role inversion, expected swapped overlap
    endpoint ordering, including start-index-rotation lanes, and input
    immutability).
- Added Rust options-path canonical-name counterpart for non-circle
  reversed-endpoint-order closure-basic-intersect fixture matrix:
  - `cpp_reversed_endpoint_closure_basic_intersect_options_matrix_parity`
  - verifies `find_intersects_opt` remains aligned with default-path
    `find_intersects` outputs across closed-`pline1` and closed-`pline2`
    branches (counts, AB/BA symmetry, overlap endpoint-set behavior, including
    start-index-rotation lanes, and input immutability).
- Added Rust options-path canonical-name counterpart for non-circle
  ...
  - verifies `find_intersects_opt` remains aligned with default-path
    `find_intersects` outputs across closed-`pline1` and closed-`pline2`
    role-flip branches (counts, AB/BA role inversion, expected swapped overlap
    endpoint ordering, rotated zero-length-lead index attribution semantics,
    and input immutability).
- Added Rust options-path canonical-name counterpart for non-circle
  reversed-endpoint-order closure-basic-intersect start-index-rotation
  ...
  - verifies `find_intersects_opt` remains aligned with default-path
    ...
    and input immutability).
- Added Rust options-path canonical-name counterpart for non-circle
  reversed-endpoint-order adjacent-line-flip both-closed start-index-rotation
  zero-length-lead role-flip fixture matrix:
  ...
  - verifies `find_intersects_opt` remains aligned with default-path
    ...
    (counts, overlap-endpoint dedup constraints, AB/BA role inversion with
    expected swapped overlap endpoint ordering, rotated zero-length-lead index
    attribution semantics, and input immutability).
- Added Rust options-path canonical-name counterpart for non-circle
  arc1-reverse-dir both-closed start-index-rotation zero-length-lead role-flip
  fixture matrix:
...
- Added Rust options-path canonical-name counterpart for non-circle
  arc2-reverse-dir both-closed start-index-rotation zero-length-lead role-flip
  fixture matrix:
...
- Added Rust options-path canonical-name counterpart for wrap-around
  ...
  - verifies `find_intersects_opt` remains aligned with default-path
    ...
    endpoint ordering, and zero-length-lead index attribution semantics.
- Added Rust options-path canonical-name counterpart for wrap-around
  non-circle arc-overlap dedup same-order start-index-rotation zero-length-lead
  role-flip fixture matrix:
...
- Added Rust options-path canonical-name counterpart for wrap-around
  ...
  - verifies `find_intersects_opt` remains aligned with default-path
    ...
    endpoint ordering, and zero-length-lead index attribution semantics.
- Added Rust options-path canonical-name counterpart for wrap-around
  non-circle arc-overlap dedup same-order start-index-rotation role-flip
  fixture matrix:
...
- Added Rust options-path canonical-name counterpart for wrap-around
  non-circle arc-overlap dedup reversed-order start-index-rotation role-flip
  fixture matrix:
  ...
  - verifies `find_intersects_opt` remains aligned with default-path
    ...
    `both_closed_start_index_rotation_closed_pline1_role_flip`,
    `both_closed_start_index_rotation_closed_pline2_role_flip`) with no-basic
    overlap-dedup behavior, AB/BA role inversion, swapped overlap endpoint
    ordering, and start-index attribution semantics.
- Added Rust options-path canonical-name counterpart for wrap-around
  overlap-endpoint arc-adjacent dedup start-index-rotation role-flip fixture
  matrix:
  ...
  - verifies `find_intersects_opt` remains aligned with default-path
    ...
    ordering, and start-index attribution semantics.
- Added Rust options-path canonical-name counterpart for wrap-around
  overlap-endpoint dedup start-index-rotation role-flip fixture matrix:
...
- Added Rust options-path canonical-name counterpart for `arc1_reverse_dir`
...
- Added Rust options-path canonical-name counterpart for `both_reverse_dir`
  both-closed start-index-rotation role-flip fixture matrix:
...
- Added canonical role-flip options-path aliases for remaining role-flip
  ...
  - each alias delegates to its existing
    ...
    canonical-name gaps.
- Added canonical non-role options-path aliases for the same closure-basic
  branch family:
...
- Added canonical matrix aliases for reversed-endpoint adjacent-line-flip
  both-closed start-index-rotation options families:
  - `cpp_reversed_endpoint_adjacent_line_flip_both_closed_start_index_rotation_options_matrix_parity`
  - `cpp_reversed_endpoint_adjacent_line_flip_both_closed_start_index_rotation_role_flip_options_matrix_parity`
  - `cpp_reversed_endpoint_adjacent_line_flip_both_closed_start_index_rotation_zero_length_lead_options_matrix_parity`
  - `cpp_reversed_endpoint_adjacent_line_flip_both_closed_start_index_rotation_zero_length_lead_role_flip_options_matrix_parity`
  - each alias delegates to the corresponding existing `*_options_parity`
...
- Added canonical matrix aliases for wrap-around closed-side-reversed
  ...
  - each alias delegates to the corresponding existing `*_options_parity`
    guard, reducing this family's
    `*_options_parity -> *_options_matrix_parity` naming gaps.
- Added canonical matrix aliases for wrap-around open-side-reversed
  closed-side-reversed options families:
  ...
  - each alias delegates to the corresponding existing `*_options_parity`
    guard, reducing this family's
    `*_options_parity -> *_options_matrix_parity` naming gaps.
- Added canonical matrix aliases for wrap-around overlap-endpoint-dedup
  start-index-rotation options families:
  - `cpp_wrap_around_overlap_endpoint_dedup_start_index_rotation_options_matrix_parity`
  - `cpp_wrap_around_overlap_endpoint_dedup_start_index_rotation_role_flip_options_matrix_parity`
  - `cpp_wrap_around_overlap_endpoint_dedup_start_index_rotation_zero_length_lead_options_matrix_parity`
  - `cpp_wrap_around_overlap_endpoint_dedup_start_index_rotation_zero_length_lead_role_flip_options_matrix_parity`
  - each alias delegates to the corresponding existing `*_options_parity`
    guard, reducing this family's
    `*_options_parity -> *_options_matrix_parity` naming gaps.
