# Phase 48: C-API Logic Alignment Map

This map captures next steps after options-path self-intersects stress matrix
deepening.
...
| P1 | Reversed-input options-path stress matrix | `cavalier_contours_ffi/tests/test_pline.rs` | Add only source-backed reversed parity checks (`invert_direction + negated delta`) with mode/tolerance options. |
