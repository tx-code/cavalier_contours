# Phase 48: capi-options-path-self-intersects-stress-matrix - Context
...
Phase 48 deepens options-path self-intersects coverage by executing a bounded
stress matrix (`mode x tolerance scale`) across source-backed simple and
specific offset cases.
