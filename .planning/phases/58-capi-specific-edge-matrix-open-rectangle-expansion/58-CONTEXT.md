# Phase 58: capi-specific-edge-matrix-open-rectangle-expansion - Context
...
Phase 58 further expands source-backed specific-edge options-path matrix
coverage by adding an additional old C++ open-path case into the helper-driven
reversed/default parity/no-modify matrix flow.

## Decisions

- **D-01:** Keep using the shared specific-edge runner helper introduced in
  Phase 56 and expanded in Phase 57.
