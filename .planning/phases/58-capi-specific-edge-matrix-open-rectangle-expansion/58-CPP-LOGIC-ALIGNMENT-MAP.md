# Phase 58: C-API Logic Alignment Map
...
- Specific-edge matrix coverage now includes additional source-backed old C++
  case inputs (`closed_rectangle_coincident` and `open_rectangle_outward`) in
  both reversed/default options-path helper flows.
